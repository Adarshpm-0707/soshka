...
const SuperAdminAddProductPage = () => {
  ...
  useEffect(() => {
    try {
      const saved = sessionStorage.getItem('superadmin_add_product_form');
      if (saved) {
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem('superadmin_add_product_form', JSON.stringify(data));
  }, [name, description, specifications, shippingPolicy, category, categoryId, originalPrice, offerPrice, stock, cost, offerId, discountPercent, sizes, images]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      sessionStorage.removeItem('superadmin_add_product_form');
