...
// Use explicit config object to avoid URL percent-encoding parsing errors
...
async function main() {
  ...
  console.log("Connected to Supabase Database via IPv4 Pooler successfully!");
  ...
  // 4. Update the RLS policies to check the whitelisted emails directly to prevent any metadata/role sync delay issues
